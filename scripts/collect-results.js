...
const REPORTS_DIR = 'app/artifacts/reports';
const FILENAME = process.env.OUTPUT_FILENAME || 'scan-results-local.json';
const OUTPUT_FILE = path.join(REPORTS_DIR, FILENAME);
